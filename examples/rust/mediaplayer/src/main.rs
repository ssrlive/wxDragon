...
impl MediaPlayerFrame {
    fn new() -> Self {
        ...
        let play_button = Button::builder(&button_panel)
            .with_label("Play")
            .build();
            
        let pause_button = Button::builder(&button_panel)
            .with_label("Pause")
            .build();
            
        let stop_button = Button::builder(&button_panel)
            .with_label("Stop")
            .build();
    ...
    fn setup_event_handlers(
        ...
        play_button.bind(EventType::COMMAND_BUTTON_CLICKED, move |_| {
            if media_ctrl.play() {
        ...
        pause_button.bind(EventType::COMMAND_BUTTON_CLICKED, move |_| {
            if media_ctrl.pause() {
        ...
        stop_button.bind(EventType::COMMAND_BUTTON_CLICKED, move |_| {
            if media_ctrl.stop() {
        ...
        open_button.bind(EventType::COMMAND_BUTTON_CLICKED, move |_| {
            let file_dialog = FileDialog::builder(Some(&frame))
