...
typedef enum {
    ...
    WXD_EVENT_TYPE_LIST_BEGIN_DRAG = 74,
    WXD_EVENT_TYPE_LIST_BEGIN_RDRAG = 75,
    WXD_EVENT_TYPE_LIST_DELETE_ITEM = 76,
    WXD_EVENT_TYPE_LIST_DELETE_ALL_ITEMS = 77,
    WXD_EVENT_TYPE_LIST_ITEM_DESELECTED = 78,
    WXD_EVENT_TYPE_LIST_ITEM_FOCUSED = 79,
    WXD_EVENT_TYPE_LIST_ITEM_MIDDLE_CLICK = 80,
    WXD_EVENT_TYPE_LIST_ITEM_RIGHT_CLICK = 81,
    WXD_EVENT_TYPE_LIST_KEY_DOWN = 82,
    WXD_EVENT_TYPE_LIST_INSERT_ITEM = 83,
    WXD_EVENT_TYPE_LIST_COL_RIGHT_CLICK = 84,
    WXD_EVENT_TYPE_LIST_COL_BEGIN_DRAG = 85,
    WXD_EVENT_TYPE_MAX
} WXDEventTypeCEnum;
